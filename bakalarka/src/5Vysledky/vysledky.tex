...
\begin{table}[h]\label{výsl 1}
    ...
    \begin{tabular}{ljkujku}
      \toprule
      Filtr$_{\frac{thread}{blok}}$ $\downarrow$ & \multicolumn{1}{c}{CPU (ms)} & \multicolumn{1}{c}{GPU (ms)} & \multicolumn{1}{c}{Urychlení} & \multicolumn{1}{c}{CPU (ms)} & \multicolumn{1}{c}{GPU (ms)} & \multicolumn{1}{c}{Urychlení}\\
      \midrule
...
\begin{table}[h]
    ...
    \begin{tabular}{ljkujku}
      ...
      \midrule
      Maska $\rightarrow$ & \multicolumn{3}{c}{kapacita masky: 27} & \multicolumn{3}{c}{kapacita masky: 19}\\
      \bottomrule
    \end{tabular}
